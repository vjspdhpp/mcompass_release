...
void initBleServer() {
  ...
  NimBLEService *pCompassService = pServer->createService("Compass");
  NimBLECharacteristic *pColorCharacteristic =
      pCompassService->createCharacteristic(
          "Color",
          NIMBLE_PROPERTY::READ | NIMBLE_PROPERTY::WRITE
      );

  pColorCharacteristic->setValue("#FF0000");
  pColorCharacteristic->setCallbacks(&chrCallbacks);
}